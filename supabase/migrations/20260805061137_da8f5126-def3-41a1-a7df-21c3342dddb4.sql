...
REVOKE ALL ON FUNCTION public.run_test_reservation_cleanup(text, text, date) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.run_test_reservation_cleanup(text, text, date) TO authenticated, service_role;