...
- **Setup guide** (owners/admins): "Set up staffing" (FI "Henkilöstön käyttöönotto", SV "Kom igång med personal") at the top of the Staffing page has four steps: 1 Add your locations (type a name, press Add location; the plan's location limit applies), 2 Add roles and staff (Open staff register), 3 Assign staff to locations (optional; pick Works at per person, or All locations; with one location there is nothing to assign), 4 Create your first shift list (Go to shift list puts the cursor on New shift list). Finished steps get a green tick and Done. "Hide guide" hides it for that business; the "Setup guide" button brings it back. A shift list for one location only offers staff who work at that location or at All locations; an All locations list offers everyone; people already on a row stay there.
