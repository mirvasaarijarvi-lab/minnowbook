...
- **Google Calendar sync**: each tenant has an iCal feed (\`.ics\`) generated by an edge function that users can subscribe to from Google Calendar, Apple Calendar, or Outlook.
