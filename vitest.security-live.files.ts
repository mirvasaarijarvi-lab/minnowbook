...
export const LIVE_SECURITY_TESTS: string[] = [
  ...
  "src/test/security/test-reservation-cleanup-authz.test.ts",
  ...
  "src/test/security/code-redemption-expired-e2e.test.ts",
  "src/test/security/code-redemption-idempotency.test.ts",
  "src/test/security/code-redemption-idempotent-ledger.test.ts",
  ...
  "src/test/security/resource-availability-cross-tenant.test.ts",
  "src/test/security/resource-images-anon-by-id.test.ts",
  "src/test/security/resource-images-anon-bypass-attempts.test.ts",
  "src/test/security/resource-images-anon-cross-tenant.test.ts",
  "src/test/security/resource-images-anon-existence-nonleak.test.ts",
  "src/test/security/resource-images-anon-pagination.test.ts",
  "src/test/security/resource-images-anon-parent-transition.test.ts",
  "src/test/security/resource-images-anon-select.test.ts",
  "src/test/security/resource-images-anon-storage-bytes.test.ts",
  "src/test/security/resource-images-authenticated-select.test.ts",
  "src/test/security/resource-images-cross-tenant-isolation-matrix.test.ts",
  "src/test/security/resource-images-cross-tenant-isolation.test.ts",
  "src/test/security/resource-images-cross-tenant-listing-sweep.test.ts",
  "src/test/security/resource-images-cross-tenant-mutations-denied.test.ts",
