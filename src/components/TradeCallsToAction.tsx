...
const trades: {
...
}[] = [
  {
    slug: "barber",
    icon: Scissors,
    nameKey: "useCases.tradeCtaBarberName",
    lineKey: "useCases.tradeCtaBarberLine",
    buttonKey: "useCases.tradeCtaBarberButton",
  },
  {
    slug: "hairdresser",
    icon: Wind,
    nameKey: "useCases.tradeCtaHairdresserName",
    lineKey: "useCases.tradeCtaHairdresserLine",
    buttonKey: "useCases.tradeCtaHairdresserButton",
  },
  {
    slug: "massage-therapist",
    icon: Sparkles,
    nameKey: "useCases.tradeCtaMassageName",
    lineKey: "useCases.tradeCtaMassageLine",
    buttonKey: "useCases.tradeCtaMassageButton",
  },
  {
    slug: "baker",
    icon: CroissantIcon,
    nameKey: "useCases.tradeCtaBakerName",
    lineKey: "useCases.tradeCtaBakerLine",
    buttonKey: "useCases.tradeCtaBakerButton",
  },
  {
    slug: "makeup-artist",
    icon: Brush,
    nameKey: "useCases.tradeCtaMakeupName",
    lineKey: "useCases.tradeCtaMakeupLine",
    buttonKey: "useCases.tradeCtaMakeupButton",
  },
  {
    slug: "personal-trainer",
    icon: Dumbbell,
    nameKey: "useCases.tradeCtaTrainerName",
    lineKey: "useCases.tradeCtaTrainerLine",
    buttonKey: "useCases.tradeCtaTrainerButton",
  },
];
