import { CalendarDays, List, Settings, LogOut, LayoutDashboard, Menu, X, ShieldCheck, Cog } from "lucide-react";
...
export type DashboardView = "overview" | "calendar" | "reservations" | "resources" | "settings" | "admin";
