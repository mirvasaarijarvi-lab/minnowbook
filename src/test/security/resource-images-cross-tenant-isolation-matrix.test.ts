...
describe.runIf(canRun)(
  "resource_images cross-tenant isolation matrix (Tenant B staff + non-staff)",
  () => {
    ...
    beforeAll(async () => {
      ...
      const bPub = await seedResourceWithImage(
        tenantBId,
        "b-public",
        true,
        "approved",
    ...
    afterAll(async () => {
      ...
      await service
        ...
        .delete()
        .in("id", [
          seeded.a.publicImageId,
          seeded.a.privateImageId,
          seeded.b.publicImageId,
        ]);
      await service
        .from("resources")
        .delete()
