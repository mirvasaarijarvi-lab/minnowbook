...
const STAFF_ONLY_CASES: Array<{
  ...
  { field: "original_price_eur", hostile: 0.01, mustNotEqual: 0.01 },
  {
    ...
    hostile: "attacker-supplied pricing",
    mustNotEqual: "attacker-supplied pricing",
  },
  {
    field: "staff_notes",
    hostile: "SHOULD_NOT_APPEAR_staff",
    mustNotEqual: "SHOULD_NOT_APPEAR_staff",
  },
  {
    field: "internal_notes",
    hostile: "SHOULD_NOT_APPEAR_internal",
    mustNotEqual: "SHOULD_NOT_APPEAR_internal",
  },
  {
    field: "discount_reason",
    hostile: "free-because-i-said-so",
    mustNotEqual: "free-because-i-said-so",
  },
  { field: "is_invoiced", hostile: true, mustNotEqual: true },
  {
    field: "created_by",
    hostile: "00000000-0000-0000-0000-000000000001",
    mustNotEqual: "00000000-0000-0000-0000-000000000001",
  },
  {
    field: "acknowledgment_email_sent_at",
    hostile: "2099-01-01T00:00:00Z",
    mustNotEqual: "2099-01-01T00:00:00Z",
  },
  {
  ...
  {
    field: "cancellation_email_sent_at",
    hostile: "2099-01-01T00:00:00Z",
    mustNotEqual: "2099-01-01T00:00:00Z",
  },
  {
...
describe.runIf(canRun)(
  "anon reservation insert — staff-only fields scrubbed (live)",
  () => {
    beforeAll(async () => {
    ...
    it("clean payload is accepted with all staff-only fields at defaults", async () => {
      ...
      expect(
        error,
        `control insert must succeed: ${error?.message}`,
      ).toBeNull();
      ...
      expect(
        readErr,
        `control read-back must succeed: ${readErr?.message}`,
      ).toBeNull();
    ...
    it.each(STAFF_ONLY_CASES)(
      ...
      async ({ field, hostile, mustNotEqual }) => {
        ...
        expect(
          data,
          `${field}: expected rejection or scrubbed row`,
        ).toBeTruthy();
