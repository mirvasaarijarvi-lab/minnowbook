...
const Onboarding = () => {
  ...
  const tiers = [
    { id: "basic", nameKey: "tier.basic" as TranslationKey, icon: Zap, price: "€19/mo", descKey: "tier.basicDesc" as TranslationKey, features: ["1 reservation type", "2 resources in total", "Up to 5 staff users", "Booking page"] },
    { id: "professional", nameKey: "tier.professional" as TranslationKey, icon: Crown, price: "€59/mo", descKey: "tier.professionalDesc" as TranslationKey, features: ["All types (up to 5 resources each)", "Up to 25 staff users", "Custom branding", "AI chatbot support"] },
    { id: "business", nameKey: "tier.business" as TranslationKey, icon: Building2, price: "€179/mo", descKey: "tier.businessDesc" as TranslationKey, features: ["Unlimited sites", "Unlimited resources", "Up to 50 staff users", "Priority support (24h)"] },
  ];
