...
import { useNavigate, Navigate, useLocation } from "@/lib/router-compat";
...
const Onboarding = () => {
  ...
  const wasRedirected =
    (location.state as { reason?: string } | null)?.reason === "no-tenant";
  ...
  const [membershipRemovedAt, setMembershipRemovedAt] = useState<string | null>(
    null,
  );
  ...
  const handleRetrySession = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Checking your access again…",
      });
      try {
  ...
  const STEPS: TranslationKey[] = [
    "onboarding.tierStep",
    "onboarding.typesStep",
    "onboarding.brandingStep",
  ];
  ...
  const tiers = [
    {
      ...
      icon: Zap,
      price: "€19/mo",
      descKey: "tier.basicDesc" as TranslationKey,
      features: [
        "1 reservation type",
    ...
    {
      id: "professional",
      nameKey: "tier.professional" as TranslationKey,
      icon: Crown,
      price: "€59/mo",
      descKey: "tier.professionalDesc" as TranslationKey,
      features: [
        "All types (up to 5 resources each)",
    ...
    },
    {
      ...
      icon: Building2,
      price: "€179/mo",
      descKey: "tier.businessDesc" as TranslationKey,
      features: [
        "Unlimited sites",
        "Unlimited resources",
  ...
  const reservationTypes = [
    {
      id: "restaurant",
      labelKey: "dashboard.restaurant" as TranslationKey,
      icon: UtensilsCrossed,
      descKey: "onboarding.restaurantDesc" as TranslationKey,
    },
    {
      id: "venue",
      labelKey: "dashboard.venue" as TranslationKey,
      icon: Building2,
      descKey: "onboarding.venueDesc" as TranslationKey,
    },
    {
      id: "guesthouse",
      labelKey: "dashboard.guesthouse" as TranslationKey,
      icon: BedDouble,
      descKey: "onboarding.guesthouseDesc" as TranslationKey,
    },
    {
      id: "hotel",
      labelKey: "dashboard.hotel" as TranslationKey,
      icon: BedDouble,
      descKey: "onboarding.hotelDesc" as TranslationKey,
    },
    {
      id: "wellness",
      labelKey: "dashboard.wellness" as TranslationKey,
      icon: HeartPulse,
      descKey: "onboarding.wellnessDesc" as TranslationKey,
    },
    {
      id: "custom",
      labelKey: "dashboard.custom" as TranslationKey,
      icon: Sparkles,
      descKey: "onboarding.customDesc" as TranslationKey,
    },
  ];
  ...
  const handleTierChange = (tierId: string) => {
    ...
    if (
      ...
      selectedTypes.length > maxReservationTypes
    ) {
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-muted-foreground mt-0.5">
                  An administrator removed your membership while you were signed
                  in. If this was a mistake, ask them to re-invite you, then
        ...
        {wasRedirected && (
          <div className="w-full max-w-2xl mb-6 rounded-md border border-accent/30 bg-accent/5 px-4 py-3 text-sm text-foreground">
            ...
            <p className="text-muted-foreground mt-0.5">
              Your account isn't connected to an organization yet. Complete
              these steps to create one and start using MimmoBook.
            </p>
          </div>
        )}
        ...
        <div className="w-full max-w-2xl">
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                <h1 className="text-2xl font-serif font-bold text-foreground">
                  {t("onboarding.whatDoYouNeed")}
                </h1>
                <p className="text-muted-foreground mt-1">
                  {t("onboarding.whatDoYouNeedSubtitle")}
                </p>
              </div>
              {(() => {
                const limits = getTierLimits(selectedTier);
                const limitLabel =
                  limits.maxReservationTypes === null
                    ? "Unlimited types"
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {reservationTypes.map((type) => {
                  ...
                  const atLimit =
                    !selected &&
                    !canSelectMoreTypes(selectedTier, selectedTypes.length);
                  return (
                    <Card
                      key={type.id}
                      className={cn(
                      ...
                      onClick={() => !atLimit && toggleType(type.id)}
                    >
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                <h1 className="text-2xl font-serif font-bold text-foreground">
                  {t("onboarding.brandWorkspace")}
                </h1>
                <p className="text-muted-foreground mt-1">
                  {t("onboarding.brandWorkspaceSubtitle")}
                </p>
              </div>
              <div className="grid gap-6 sm:grid-cols-2">
                <Card>
                  <CardContent className="p-5 space-y-4">
                    ...
                    <div>
                      <Label>{t("onboarding.businessNameRequired")}</Label>
                      <Input
                ...
                <Card>
                  <CardContent className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {(
                        [
                          ["primaryColor", "onboarding.primary"],
                          ["secondaryColor", "onboarding.secondary"],
              ...
              <CardContent className="pt-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    You can redeem it after creating your workspace in Settings.
                  </p>
                </div>
              </CardContent>
            </Card>
