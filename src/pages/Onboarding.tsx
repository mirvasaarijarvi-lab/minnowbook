...
const Onboarding = () => {
  ...
  const tiers = [
    ...
    { id: "professional", nameKey: "tier.professional" as TranslationKey, icon: Crown, price: "€79/mo", descKey: "tier.professionalDesc" as TranslationKey, features: ["All types (1 resource each)", "10 staff users", "Custom branding", "AI chatbot support"] },
    { id: "business", nameKey: "tier.business" as TranslationKey, icon: Building2, price: "€199/mo", descKey: "tier.businessDesc" as TranslationKey, features: ["Unlimited sites", "Unlimited resources", "Unlimited staff", "Priority support (24h)"] },
  ];
