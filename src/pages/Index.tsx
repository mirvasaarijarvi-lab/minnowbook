      ...
      <SEOHead
        ...
        jsonLd={[
          ...
          faqSchema([
            ...
            { question: "Does MimmoBook support multiple locations?", answer: "Yes, the Business plan supports unlimited sites and locations with centralized management, per-site branding, and independent booking pages." },
