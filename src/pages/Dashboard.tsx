...
const TOUR_STORAGE_KEY = "mimmobook-tour-completed";
...
const tourSteps: TourStep[] = [
  {
    ...
    content:
      "Here you can see today's key metrics at a glance — reservations, pending bookings, confirmed count, and active resources.",
    placement: "bottom",
    view: "overview",
  },
  {
    ...
    content:
      "Share this link with your customers so they can make reservations online. Copy it or open it in a new tab to preview.",
    placement: "top",
    view: "overview",
  },
  {
    ...
    title: "Navigation",
    content:
      "Use the sidebar to switch between Calendar, Reservations, Resources, Reports, Settings, and more.",
    placement: "right",
    view: "overview",
  },
  {
    ...
    title: "Calendar View",
    content:
      "Browse reservations month-by-month. Dates with bookings are highlighted so you can spot busy days at a glance.",
    placement: "bottom",
    view: "calendar",
  },
  {
    ...
    title: "Day Details",
    content:
      "Click any date to see its reservations listed here — guest names, times, party sizes, and statuses.",
    placement: "left",
    view: "calendar",
  },
  {
    ...
    content:
      "Use the status, type, and date filters to quickly narrow down your reservation list. Toggle 'Today' for a quick daily view.",
    placement: "bottom",
    view: "reservations",
  },
  {
    ...
    content:
      "Add and manage your bookable spaces — rooms, tables, or venues. Set capacity, pricing, and upload photos for each resource.",
    placement: "bottom",
    view: "resources",
  },
  {
    ...
    content:
      "Each card shows a resource with its type, capacity, pricing, and status. Click Edit to update details or toggle active/inactive to control availability.",
    placement: "top",
    view: "resources",
  },
  {
    ...
    content:
      "Filter reports by time period — week, month, quarter, or year. Use the compare toggle to see trends against previous periods. Export or print reports as needed.",
    placement: "bottom",
    view: "reports",
  },
  {
    ...
    title: "Settings",
    content:
      "Configure your branding, upload your logo and hero image, set business details, customize colors, and manage email templates.",
    placement: "top",
    view: "settings",
  },
  {
    ...
    title: "Profile",
    content:
      "Update your display name and upload a profile photo so your team can identify you easily.",
    placement: "top",
    view: "profile",
  },
];
...
const Dashboard = () => {
  ...
  const { impersonating, isImpersonating, stopImpersonation } =
    useImpersonation();
  ...
  const [reservationStatusFilter, setReservationStatusFilter] = useState<
    string | undefined
  >();
  const [reservationInvoicedFilter, setReservationInvoicedFilter] = useState<
    boolean | undefined
  >();

  const [reservationCheckoutTodayFilter, setReservationCheckoutTodayFilter] =
  ...
  const viewComponents: Record<DashboardView, React.ReactNode> = {
    ...
    calendar: gatedView(
      ...
      <div className="space-y-6">
        <CalendarView />
        <AvailabilityTimelinePanel />
      </div>,
    ),
    reservations: gatedView(
      "reservations",
      <>
        <RescheduleRequestsPanel />
        <ReservationList
          initialStatusFilter={reservationStatusFilter}
          initialInvoicedFilter={reservationInvoicedFilter}
          initialCheckoutToday={reservationCheckoutTodayFilter}
        />
      </>,
    ),
            ...
            {samplePeriod.isBlocked ? (
              <div className="flex-1 flex flex-col items-center justify-center p-8 text-center gap-4">
                ...
                <p className="text-muted-foreground max-w-md">
                  Your free trial has expired. Please contact support to
                  reactivate your account or upgrade to a paid plan.
                </p>
              </div>
            ) : (
              <main
                className={`flex-1 p-4 sm:p-6 lg:p-8 overflow-x-hidden overflow-y-auto ${samplePeriod.isReadOnly ? "pointer-events-none opacity-75" : ""}`}
              >
