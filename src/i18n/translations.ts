...
type TranslationKeys = {
  ...
  "offers.trace.showDetails": string;
  "offers.trace.statusCompleted": string;
  "offers.trace.hideDetails": string;
...
const en: TranslationKeys = {
  ...
  "pricing.staffPayroll":
    "Payroll Excel for any pay period and shift change history",
  "pricing.staffLocations": "Shift lists per location and staff access review",
  "support.faqC8":
    "How do I build a shift list? Open Staffing, press Staff to add roles and people, then New shift list. Pick the role and name on each row and type shifts like 10-18, or codes V, X, Z, L and P for days off and leave. Rows total hours, Sunday and holiday, evening and night hours using your Pay rules and ratios. Pro and Business also record realized hours, download CSV and show staffing needs per hour from your bookings. Business adds a payroll Excel file and a change history. All plans can keep as many shift lists as they need. With several locations, each list belongs to one location or to all locations: choose it when creating the list or later under Location of this list, and the Location filter shows that location's lists plus all-locations lists.",
  "support.faqC9":
    "How do I get started with Staffing? Owners and admins see Set up staffing at the top of the Staffing page. It walks through four steps: add your locations, add roles and staff, assign staff to locations with Works at (optional; All locations means they can work anywhere), and create your first shift list. Finished steps get a green tick. Hide guide tucks it away and the Setup guide button brings it back. A shift list for one location only offers staff who work there or at all locations.",
  "features.staffing": "Staffing and Shift Lists",
  "features.staffingDesc":
    "Build multi-week shift lists with roles, leave codes and automatic hour totals, record realized hours, print worker sheets, export payroll and see hour by hour where your bookings need more staff.",
  "support.faqC7":
  ...
  "blog.ofStep2Desc":
    "One click fills the offer with the booking details. You add menu and price.",
  "blog.ofStep3Title": "Offer email",
  "blog.ofStep3Desc": "The guest receives your branded offer by email.",
  "blog.ofStep4Title": "Confirm",
  "blog.ofStep4Desc":
    "The guest accepts, you press Confirm and the booking becomes a full reservation.",
  "blog.ofBenefitsTitle": "Why it helps",
  "blog.ofBenefit1Title": "No retyping",
  "blog.ofBenefit1Desc":
    "Guest details move over on their own, so there are no typos in names or dates.",
  "blog.ofBenefit2Title": "No double bookings",
  "blog.ofBenefit2Desc":
    "The original booking is confirmed, not copied, so the guest has one booking.",
  "blog.ofBenefit3Title": "Faster replies",
  "blog.ofBenefit3Desc":
    "Answer an enquiry with a proper offer in minutes while the guest is still keen.",
  "blog.ofBenefit4Title": "Clear reports",
  "blog.ofBenefit4Desc":
    "Reports show which bookings came through an offer and what they were worth.",
  ...
  "offers.trace.showDetails": "Show details",
  "offers.trace.statusCompleted": "Completed",
  "offers.trace.hideDetails": "Hide details",
...
const fi: TranslationKeys = {
  ...
  "pricing.staffPayroll":
    "Palkanlaskennan Excel mille tahansa palkkakaudelle ja vuorojen muutoshistoria",
  "pricing.staffLocations":
    "Toimipistekohtaiset vuorolistat ja käyttöoikeuksien tarkistus",
  "support.faqC8":
    "Miten teen vuorolistan? Avaa Työvuorot, lisää Henkilöstö-kohdassa tehtävät ja henkilöt ja paina Uusi vuorolista. Valitse rivillä tehtävä ja nimi ja kirjoita vuorot, esim. 10-18, tai koodit V, X, Z, L ja P vapaille ja lomille. Rivit laskevat tunnit, sunnuntai- ja pyhätunnit sekä ilta- ja yötunnit Palkkasääntöjen mukaan. Pro ja Business kirjaavat myös toteutuneet tunnit, lataavat CSV:n ja näyttävät tunneittaisen henkilöstötarpeen varauksista. Business lisää palkanlaskennan Excel-tiedoston ja muutoshistorian. Kaikissa paketeissa voi pitää niin monta vuorolistaa kuin tarvitsee. Jos toimipisteitä on useampi, jokainen lista kuuluu yhdelle toimipisteelle tai kaikille: valitse se listaa tehdessä tai myöhemmin kohdasta Listan toimipiste. Toimipiste-suodatin näyttää sen toimipisteen listat sekä kaikkien toimipisteiden listat.",
  "support.faqC9":
    "Miten otan Työvuorot käyttöön? Omistajat ja ylläpitäjät näkevät Työvuorot-sivun yläosassa Henkilöstön käyttöönotto -oppaan. Se käy läpi neljä vaihetta: lisää toimipisteet, lisää roolit ja henkilöstö, liitä henkilöstö toimipisteisiin (valinnainen; Kaikki toimipisteet tarkoittaa, että henkilö voi työskennellä missä tahansa) ja luo ensimmäinen vuorolista. Valmiit vaiheet saavat vihreän merkin. Piilota opas piilottaa sen ja Käyttöönotto-opas-painike tuo sen takaisin. Yhden toimipisteen vuorolista tarjoaa vain sen toimipisteen ja kaikkien toimipisteiden henkilöstöä.",
  "features.staffing": "Työvuorot ja henkilöstö",
  "features.staffingDesc":
    "Rakenna usean viikon vuorolistat tehtävineen ja lomakoodeineen, tunnit lasketaan automaattisesti. Kirjaa toteumat, tulosta työntekijän listat, vie palkanlaskentaan ja näe tunneittain, missä varaukset tarvitsevat lisää väkeä.",
  "support.faqC7":
  ...
  "blog.post10Title":
    "Asiakkaan varauksesta tarjoukseksi yhdellä painalluksella",
  "blog.post10Excerpt":
    "Tee verkkosivusi varauspyynnöstä valmis tarjous kirjoittamatta mitään uudelleen ja vahvista se oikeaksi varaukseksi, kun asiakas sanoo kyllä.",
  "blog.post10C1":
    "Moni varaus on oikeastaan keskustelun alku. Asiakas kysyy tilaa 30 hengen syntymäpäiväillalliselle, tyhy-päivää lounaalla tai hääruokien maistelua. Varaussivu kerää perustiedot, mutta menusta, hinnasta ja yksityiskohdista pitää vielä sopia. Tähän asti se tarkoitti tietojen kopioimista käsin varaukselta erilliseen tarjoukseen.",
  "blog.post10C2":
    "MimmoBookissa avaat nyt asiakkaan varauksen ja painat Tee tarjous. Nimi, sähköposti, puhelin, päivä, ajat, henkilömäärä, tila, tapahtuman tyyppi, erityistoiveet ja kieli siirtyvät tarjoukselle automaattisesti. Lisäät vain sen, mitä asiakas ei voinut tietää: menun, hinnan, tarjouksen voimassaolon ja laskutustiedot.",
  "blog.post10C3":
    "Tarjous lähtee brändättynä PDF:nä ja sähköpostina kuten mikä tahansa tarjous. Kun asiakas hyväksyy, paina Vahvista. MimmoBook tekee alkuperäisestä varauksesta täyden vahvistetun varauksen sovitulla hinnalla ja tilalla ja lisää mahdolliset yhdistetyt varaukset, kuten huoneet tai ruokailun. Asiakkaalle ei synny kahta varausta, ja raporteista näkyy, että varaus tuli tarjouksen kautta.",
  "blog.post10C4":
    "Tarjoukset sisältyvät jokaiseen MimmoBookin tilaukseen Basicista alkaen. Jos otat jo tapahtuma- tai ryhmätiedusteluja varaussivun kautta, kokeile seuraavalla kerralla: siihen menee minuutti vartin sijaan.",
  ...
  "blog.ofStep2Desc":
    "Yksi painallus täyttää tarjouksen varauksen tiedoilla. Lisäät menun ja hinnan.",
  ...
  "blog.ofStep4Desc":
    "Asiakas hyväksyy, painat Vahvista ja varauksesta tulee täysi varaus.",
  "blog.ofBenefitsTitle": "Miksi siitä on hyötyä",
  "blog.ofBenefit1Title": "Ei uudelleenkirjoittamista",
  "blog.ofBenefit1Desc":
    "Asiakkaan tiedot siirtyvät itsestään, joten nimissä ja päivissä ei ole kirjoitusvirheitä.",
  "blog.ofBenefit2Title": "Ei tuplavarauksia",
  "blog.ofBenefit2Desc":
    "Alkuperäinen varaus vahvistetaan eikä kopioida, joten asiakkaalla on yksi varaus.",
  "blog.ofBenefit3Title": "Nopeammat vastaukset",
  "blog.ofBenefit3Desc":
    "Vastaa tiedusteluun kunnon tarjouksella minuuteissa, kun asiakas on vielä innoissaan.",
  "blog.ofBenefit4Title": "Selkeät raportit",
  "blog.ofBenefit4Desc":
    "Raporteista näet, mitkä varaukset tulivat tarjouksen kautta ja mikä niiden arvo oli.",
  ...
  "offers.trace.showDetails": "Näytä tiedot",
  "offers.trace.statusCompleted": "Toteutunut",
  "offers.trace.hideDetails": "Piilota tiedot",
...
const sv: TranslationKeys = {
  ...
  "pricing.staffPayroll":
    "Löne-Excel för valfri löneperiod och ändringshistorik för turer",
  "pricing.staffLocations":
    "Turlistor per plats och granskning av personalens behörigheter",
  "support.faqC8":
    "Hur gör jag en turlista? Öppna Personal, lägg till uppgifter och personer under Personal och tryck Ny turlista. Välj uppgift och namn på varje rad och skriv turer som 10-18, eller koderna V, X, Z, L och P för lediga dagar och semester. Raderna summerar timmar, sön- och helgtimmar samt kvälls- och nattimmar enligt dina löneregler. Pro och Business registrerar även utförda timmar, laddar ner CSV och visar personalbehov per timme utifrån bokningarna. Business lägger till en lönefil i Excel och ändringshistorik. Alla paket kan ha så många turlistor som behövs. Med flera platser hör varje lista till en plats eller till alla platser: välj det när listan skapas eller senare under Listans plats. Platsfiltret visar platsens listor och listor för alla platser.",
  "support.faqC9":
    "Hur kommer jag igång med Personal? Ägare och administratörer ser Kom igång med personal högst upp på sidan Personal. Den går igenom fyra steg: lägg till platser, lägg till roller och personal, koppla personal till platser med Arbetar på (valfritt; Alla platser betyder att personen kan arbeta överallt) och skapa din första turlista. Klara steg får en grön bock. Dölj guiden döljer den och knappen Kom igång-guide visar den igen. En turlista för en plats erbjuder bara personal som arbetar där eller på alla platser.",
  "features.staffing": "Personal och turlistor",
  "features.staffingDesc":
    "Bygg turlistor över flera veckor med uppgifter och ledighetskoder och automatiska timsummor, registrera utförda timmar, skriv ut personliga listor, exportera till lön och se timme för timme var bokningarna behöver mer personal.",
  "support.faqC7":
  ...
  "blog.post10Excerpt":
    "Gör en bokningsförfrågan från din webbplats till ett färdigt erbjudande utan att skriva om något, och bekräfta den till en riktig bokning när gästen säger ja.",
  "blog.post10C1":
    "Många bokningar är egentligen början på ett samtal. En gäst frågar efter en lokal för en födelsedagsmiddag för 30, en teamdag med lunch eller en provsmakning inför bröllop. Bokningssidan fångar grunderna, men meny, pris och detaljer måste fortfarande bestämmas. Hittills innebar det att kopiera allt från bokningen till ett separat erbjudande för hand.",
  "blog.post10C2":
  ...
  "blog.post10C3":
    "Erbjudandet skickas med din varumärkta PDF och e-post, precis som alla andra erbjudanden. När gästen accepterar trycker du på Bekräfta. MimmoBook gör den ursprungliga bokningen till den fullständiga bekräftade bokningen med överenskommet pris och utrymme, och lägger till eventuella länkade bokningar som rum eller middag. Gästen får aldrig två bokningar, och rapporterna visar att bokningen kom via ett erbjudande.",
  "blog.post10C4":
    "Erbjudanden ingår i alla MimmoBooks planer, från Basic och uppåt. Tar du redan emot evenemangs- eller gruppförfrågningar via bokningssidan, prova på nästa: det tar en minut i stället för en kvart.",
  ...
  "blog.ofStep2Desc":
    "Ett klick fyller erbjudandet med bokningens uppgifter. Du lägger till meny och pris.",
  ...
  "blog.ofStep4Desc":
    "Gästen accepterar, du trycker på Bekräfta och bokningen blir en fullständig bokning.",
  "blog.ofBenefitsTitle": "Varför det hjälper",
  "blog.ofBenefit1Title": "Inget omskrivande",
  "blog.ofBenefit1Desc":
    "Gästens uppgifter följer med av sig själva, så inga stavfel i namn eller datum.",
  "blog.ofBenefit2Title": "Inga dubbelbokningar",
  "blog.ofBenefit2Desc":
    "Den ursprungliga bokningen bekräftas, inte kopieras, så gästen har en bokning.",
  "blog.ofBenefit3Title": "Snabbare svar",
  "blog.ofBenefit3Desc":
    "Svara på en förfrågan med ett riktigt erbjudande på några minuter medan gästen är intresserad.",
  "blog.ofBenefit4Title": "Tydliga rapporter",
  "blog.ofBenefit4Desc":
    "Rapporterna visar vilka bokningar som kom via ett erbjudande och vad de var värda.",
  ...
  "offers.trace.showDetails": "Visa detaljer",
  "offers.trace.statusCompleted": "Genomförd",
  "offers.trace.hideDetails": "Dölj detaljer",
