...
const en: TranslationKeys = {
  ...
  "help.art5C1": "Set default opening hours per reservation type (restaurant, venue, hotel, wellness, custom) at the organization level. They apply to every matching resource unless overridden.",
  "help.art5C2": "Vary open and close times per day of the week, and mark individual days as closed.",
  "help.art5C3": "Opening hours determine available time slots on the public booking page.",
  "help.art5C4": "Override defaults at site or resource level, and use blocked slots for temporary closures.",
  ...
  "help.art8C2": "Professional (€59/mo): All types, up to 25 staff, custom templates, AI chatbot support.",
  "help.art8C3": "Business (€179/mo): All types, up to 50 staff, priority support with 24h response.",
  "help.art8C4": "Enterprise (by offer): unlimited staff users. Upgrade or downgrade anytime, changes take effect next billing cycle.",
  ...
  "aid.guideA6": "In **Settings → Opening Hours**, set defaults per reservation type with different open and close times for each day of the week. Mark individual days as closed. On Business plan you can override per site, and any resource can have its own weekly schedule from the resource edit dialog.",
  ...
  "support.openingHoursC1": "Set default opening hours per reservation type (restaurant, venue, hotel, wellness, custom) at the organization level. They apply to every matching resource unless overridden.",
  "support.openingHoursC2": "Pick the same hours for every open day, or set different hours per day, and mark individual days as closed.",
  "support.openingHoursC3": "Opening hours drive which time slots appear on the public booking page.",
  "support.openingHoursC4": "Use blocked slots to temporarily close a specific date or time range without changing your weekly schedule.",
  ...
  "support.billingC1": "Basic (€19/mo): 1 type, 1 to 5 staff users, AI chatbot support.",
  "support.billingC2": "Professional (€59/mo): All types (one per type), up to 25 staff users, AI chatbot support.",
  "support.billingC3": "Business (€179/mo): All types and unlimited number, unlimited number staff users, priority support with 24h response.",
...
const fi: TranslationKeys = {
  ...
  "hero.subtitle": "Käsittele ja hoida palvelusi varauksia, ravintolavarauksia, tapahtumapaikkojen tiedusteluja sekä hotelli- tai majatalovarauksia yhden hallintapaneelin avulla. Voit luoda omat brändätyt varaussivut, lähettää automaattisia sähköposteja vahvistuksiin. Hintaan sisältyy myös käyttäjähallinta.",
  ...
  "help.art5C1": "Aseta oletusaukioloajat varaustyypeittäin (ravintola, juhlatila, hotelli, hyvinvointi, mukautettu) organisaatiotasolla. Ne koskevat kaikkia kyseisen tyypin resursseja, ellei niitä ohiteta.",
  "help.art5C2": "Aseta avaamis- ja sulkemisajat erikseen jokaiselle viikonpäivälle ja merkitse yksittäiset päivät suljetuiksi.",
  "help.art5C3": "Aukioloajat määrittävät, mitkä aikavälit näkyvät julkisella varaussivulla.",
  "help.art5C4": "Ohita oletukset toimipiste- tai resurssitasolla ja käytä estettyjä aikoja tilapäisiin sulkemisiin.",
  ...
  "help.art8C3": "Business (179 €/kk): Kaikki tyypit, jopa 50 henkilöä, prioriteettituki 24h vasteajalla.",
  "help.art8C4": "Enterprise (tarjouksen mukaan): rajaton määrä käyttäjiä. Päivitä tai alenna milloin tahansa, muutokset astuvat voimaan seuraavalla laskutuskaudella.",
  ...
  "support.openingHoursC1": "Aseta varaustyypeille (ravintola, tapahtumapaikka, hotelli, hyvinvointi, mukautettu) oletusaukioloajat organisaatiotasolla. Ne koskevat kaikkia kyseisen tyypin resursseja, ellei niitä ohiteta.",
  "support.openingHoursC2": "Valitse samat ajat kaikille avoimille päiville tai aseta eri ajat per päivä, ja merkitse yksittäisiä päiviä suljetuiksi.",
  "support.openingHoursC3": "Aukioloajat määrittävät, mitkä aikavälit näkyvät julkisella varaussivulla.",
  "support.openingHoursC4": "Käytä estettyjä aikoja sulkeaksesi tilapäisesti tietyn päivän tai aikavälin muuttamatta viikko-ohjelmaa.",
  ...
  "support.billingC1": "Basic (19 €/kk): 1 varaustyyppi, 1-5 työntekijäkäyttäjää, tekoälychatbot-tuki.",
  "support.billingC2": "Professional (59 €/kk): Kaikki varaustyypit (yksi per tyyppi), jopa 25 työntekijäkäyttäjää, tekoälychatbot-tuki.",
  "support.billingC3": "Business (179 €/kk): Kaikki varaustyypit ja rajoittamaton määrä, rajoittamaton määrä työntekijäkäyttäjiä, prioriteettituki 24 tunnin vasteajalla.",
  ...
  "blog.post1C4": "Kolmanneksi asiakasviestintä on epäjohdonmukaista. Jotkut vieraat saavat vahvistussähköpostin, toiset eivät. Automaattiset sähköpostivirrat varmistavat, että jokainen vieras saa saman ammattimaisen kokemuksen.",
...
const sv: TranslationKeys = {
  ...
  "help.art5C1": "Ange standardöppettider per bokningstyp (restaurang, lokal, hotell, wellness, anpassad) på organisationsnivå. De gäller alla resurser av den typen om de inte åsidosätts.",
  "help.art5C2": "Variera öppnings- och stängningstider per veckodag och markera enskilda dagar som stängda.",
  "help.art5C3": "Öppettider styr vilka tider som visas på den publika bokningssidan.",
  "help.art5C4": "Åsidosätt standardvärden på plats- eller resursnivå och använd blockerade tider för tillfälliga stängningar.",
  ...
  "help.art8C1": "Basic (19 €/mån): 1 typ, 1 till 5 personal, AI-chatbot-support.",
  "help.art8C2": "Professional (59 €/mån): Alla typer, upp till 25 personal, anpassade mallar, AI-chatbot-support.",
  "help.art8C3": "Business (179 €/mån): Alla typer, upp till 50 personal, prioritetssupport med 24h svarstid.",
  "help.art8C4": "Enterprise (enligt offert): obegränsat antal personalanvändare. Uppgradera eller nedgradera när som helst, ändringar börjar gälla nästa faktureringsperiod.",
  ...
  "support.openingHoursC1": "Ställ in standardöppettider per bokningstyp (restaurang, lokal, hotell, friskvård, anpassad) på organisationsnivå. De gäller alla matchande resurser om de inte åsidosätts.",
  "support.openingHoursC2": "Välj samma tider för alla öppna dagar eller olika tider per dag, och markera enskilda dagar som stängda.",
  "support.openingHoursC3": "Öppettiderna styr vilka tidsluckor som visas på den publika bokningssidan.",
  "support.openingHoursC4": "Använd blockerade tidsluckor för att tillfälligt stänga ett specifikt datum eller tidsintervall utan att ändra veckoschemat.",
  ...
  "support.billingC1": "Basic (19 €/mån): 1 reserveringstyp, 1 till 5 anställda, AI-chatbotsupport.",
  "support.billingC2": "Professional (59 €/mån): Alla reserveringstyper (en per typ), upp till 25 anställda, AI-chatbotsupport.",
  "support.billingC3": "Business (179 €/mån): Alla reserveringstyper och obegränsat antal, obegränsat antal anställda, prioriterad support med 24 timmars svar.",
