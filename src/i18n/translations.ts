...
const en: TranslationKeys = {
  ...
  "features.subtitle": "A complete toolkit for hospitality businesses.",
  ...
  // Pricing
  "pricing.title": "Plans for all needs",
  "pricing.subtitle": "Start with a 30-day free trial on any plan. Scale up as your business grows.",
  "pricing.simpleTitle": "Simple, transparent pricing",
  "pricing.simpleSubtitle": "Start with a 30-day free trial. Upgrade or cancel anytime.",
  ...
  // Tiers
  "tier.basic": "Basic",
  "tier.basicDesc": "Perfect for small hotel, restaurant or an event venue.",
  "tier.pro": "Pro",
  "tier.proDesc": "For businesses offering hotel, restaurant and event venue in one site.",
  "tier.professional": "Professional",
  "tier.professionalDesc": "Multiple reservation types, team management.",
  "tier.business": "Business",
  "tier.businessDesc": "Full-featured platform for multisite and multioperations businesses.",
  ...
  "about.missionP1": "Small hospitality businesses deserve practical and informative tools to operate more efficiently. We started MinnowBook to make that happen.",
  ...
  "help.art8C2": "Pro (€59/mo) — All types, 10 staff, custom templates, AI chatbot support.",
  "help.art8C3": "Business (€99/mo) — All types, unlimited staff, priority support with 24h response.",
  ...
  // Pricing page
  "pricing.heroTitle": "Plans for all needs",
  "pricing.heroSubtitle": "Start with a 30-day free trial on any plan. Scale up as your business grows.",
  "pricing.basicName": "Basic",
  "pricing.basicDesc": "Perfect for small hotel, restaurant or an event venue.",
  "pricing.basicTypes": "1 type",
  "pricing.basicStaff": "1–3",
  "pricing.proName": "Pro",
  "pricing.proDesc": "For businesses offering hotel, restaurant and event venue in one site.",
  "pricing.proTypes": "Up to 3 types, 1 of each",
  "pricing.proStaff": "Up to 10",
  "pricing.businessName": "Business",
  "pricing.businessDesc": "Full-featured platform for multisite and multioperations businesses.",
  ...
  "support.billingC2": "Pro (€59/mo): All types (one per type), up to 10 staff users, AI chatbot support.",
  "support.billingC3": "Business (€99/mo): All types and unlimited number, unlimited number staff users, priority support with 24h response.",
...
const fi: TranslationKeys = {
  ...
  "help.art8C2": "Pro (59 €/kk) — Kaikki tyypit, 10 henkilöä, mukautetut mallit, AI-chatbot-tuki.",
  "help.art8C3": "Business (99 €/kk) — Kaikki tyypit, rajaton henkilöstö, prioriteettituki 24h vasteajalla.",
  ...
  // Pricing page
  "pricing.heroTitle": "Suunnitelmat kaikkiin tarpeisiin",
  "pricing.heroSubtitle": "Aloita 30 päivän ilmaisella kokeilulla millä tahansa suunnitelmalla. Skaalaa ylöspäin yrityksesi kasvaessa.",
  "pricing.basicName": "Basic",
  "pricing.basicDesc": "Täydellinen pienelle hotellille, ravintolalle tai juhlatilalle.",
  "pricing.basicTypes": "1 tyyppi",
  "pricing.basicStaff": "1–3",
  "pricing.proName": "Pro",
  "pricing.proDesc": "Yrityksille, jotka tarjoavat hotelli-, ravintola- ja juhlatilavaraustyypit yhdessä toimipisteessä.",
  "pricing.proTypes": "Enintään 3 tyyppiä, 1 kutakin",
  "pricing.proStaff": "Enintään 10",
  "pricing.businessName": "Business",
  "pricing.businessDesc": "Täysivarusteinen alusta monitoimipiste- ja monipalveluyrityksille.",
  "pricing.businessTypes": "Kaikki 3 tyyppiä, rajaton määrä",
  "pricing.businessStaff": "Rajaton",
  "pricing.basicF1": "Oma brändäys (logo, värit, kuvat)",
  "pricing.basicF2": "Oletussähköpostipohjat",
  "pricing.basicF3": "Aukioloaikojen määritys",
  "pricing.basicF4": "Brändätty varaussivu",
  "pricing.basicF5": "AI-chatbot-tuki",
  "pricing.proF1": "Kaikki Basic-ominaisuudet",
  "pricing.proF2": "Mukautetut sähköpostipohjat",
  "pricing.proF3": "AI-chatbot-tuki",
  "pricing.businessF1": "Kaikki Pro-ominaisuudet",
  "pricing.businessF2": "Rajaton määrä toimipisteitä, palveluja ja henkilökuntaa",
  "pricing.businessF3": "Edistynyt raportointi",
  ...
  "support.gettingStartedDesc": "Luo tilisi ja perusta ensimmäinen varaussivusi.",
  "support.gettingStartedC1": "Rekisteröidy ilmaiseen 30 päivän kokeiluun.",
  ...
  "support.emailTemplatesDesc": "Business-tason asiakas voi muokata vieraille lähetettäviä vahvistus- ja peruutussähköposteja.",
  ...
  "support.brandingTitle": "Asetukset ja resurssisivut",
  ...
  "support.brandingC3": "Yrityskuvaus näkyy varaussivulla vieraille.",
  "support.brandingC4": "",
  ...
  "support.openingHoursC4": "Käytä estettyjä aikoja sulkeaksesi tilapäisesti tietyt tunnit tai päivämäärät.",
  ...
  "support.staffC4": "Suunnitelmissa on henkilökunnan ja varaustyyppien rajamäärät, päivitä saadaksesi lisää.",
  ...
  "support.billingC2": "Pro (59 €/kk): Kaikki tyypit (yksi kutakin), enintään 10 henkilökuntaa, AI-chatbot-tuki.",
  "support.billingC3": "Business (99 €/kk): Kaikki tyypit ja rajaton määrä, rajaton henkilökunta, prioriteettituki 24h vasteajalla.",
  ...
  "support.faqC1": "K: Voinko käyttää omaa domainia? V: Omat domainit ovat tiekartalla.",
  "support.faqC2": "K: Miten vieraat saavat vahvistuksen? V: Automaattisesti sähköpostilla kun vahvistat varauksen.",
  "support.faqC3": "K: Voinko viedä tietojani? V: Kyllä, raportit voidaan viedä Raportit-paneelista.",
  "support.faqC4": "K: Mikä ero on AI-chatbotilla ja prioriteettituella? V: Kaikki suunnitelmat sisältävät MinnowAid-tekoälychatbotin 24/7. Business-paketti lisää alustalle tehtävät tukipyynnöt taatulla 24h vasteajalla.",
  "support.faqC5": "",
...
const sv: TranslationKeys = {
  ...
  "help.art8C2": "Pro (59 €/mån) — Alla typer, 10 personal, anpassade mallar, AI-chatbot-support.",
  "help.art8C3": "Business (99 €/mån) — Alla typer, obegränsad personal, prioritetssupport med 24h svarstid.",
  ...
  // Pricing page
  "pricing.heroTitle": "Planer för alla behov",
  "pricing.heroSubtitle": "Börja med en 30 dagars gratis provperiod på valfri plan. Skala upp när ditt företag växer.",
  "pricing.basicName": "Basic",
  "pricing.basicDesc": "Perfekt för ett litet hotell, en restaurang eller en eventlokal.",
  "pricing.basicTypes": "1 typ",
  "pricing.basicStaff": "1–3",
  "pricing.proName": "Pro",
  "pricing.proDesc": "För företag som erbjuder hotell, restaurang och eventlokal på en plats.",
  "pricing.proTypes": "Upp till 3 typer, 1 av varje",
  "pricing.proStaff": "Upp till 10",
  "pricing.businessName": "Business",
  "pricing.businessDesc": "Fullfjädrad plattform för multisite- och multioperationsföretag.",
  ...
  "support.gettingStartedDesc": "Skapa ditt konto och din första bokningssida.",
  ...
  "support.emailTemplatesDesc": "Business-kunder kan anpassa bekräftelse- och avbokningsmeddelanden till gäster.",
  ...
  "support.openingHoursC4": "Använd blockerade tider för att tillfälligt stänga specifika timmar eller datum.",
  ...
  "support.staffC4": "Planerna har gränser för personalanvändare och bokningstyper, uppgradera för att lägga till fler.",
  ...
  "support.billingC2": "Pro (59 €/mån): Alla typer (en per typ), upp till 10 personal, AI-chatbot-support.",
  "support.billingC3": "Business (99 €/mån): Alla typer och obegränsat antal, obegränsad personal, prioriterad support med 24h svar.",
  ...
  "support.faqC1": "F: Kan jag använda min egen domän? S: Egna domäner finns på vår roadmap.",
  "support.faqC2": "F: Hur får gäster bekräftelser? S: Automatiskt via e-post när du bekräftar en bokning.",
  "support.faqC3": "F: Kan jag exportera mina data? S: Ja, rapporter kan exporteras från Rapporter-panelen.",
  "support.faqC4": "F: Vad är skillnaden mellan AI-chatbot och prioriterad support? S: Alla planer inkluderar MinnowAid, vår 24/7 AI-chatbot. Business-planen lägger till supportförfrågningar på plattformen med garanterat 24-timmarssvar.",
  "support.faqC5": "",
