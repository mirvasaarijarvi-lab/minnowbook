...
const en: TranslationKeys = {
  ...
  "help.art8C3": "Business (€179/mo): All types, unlimited staff, priority support with 24h response.",
  ...
  "offers.kitchenPreviewTotal": "{count} kitchen order line(s)",
...
const fi: TranslationKeys = {
  ...
  "offers.kitchenPreviewTotal": "{count} keittiötilauksen riviä",
...
const sv: TranslationKeys = {
  ...
  "offers.kitchenPreviewTotal": "{count} rader i köksordern",
