...
const en: TranslationKeys = {
  ...
  "privacy.s1P1": "This privacy policy explains how MimoBook collects, uses, stores, and protects your personal data when you use our reservation management platform. We are committed to protecting your privacy in accordance with the EU General Data Protection Regulation (GDPR).",
  "privacy.s2Title": "2. Data Controller",
  "privacy.s2P1": "MimoBook is the data controller for the personal data processed through this platform. For data protection inquiries, please contact us through the Support page.",
  ...
  "help.aiTitle": "MimoSupporter",
  "help.aiSubtitle": "Ask anything about MimoBook",
  ...
  "help.art8C2": "Pro (€79/mo) — All types, 10 staff, custom templates, AI chatbot support.",
...
const fi: TranslationKeys = {
  ...
  "help.aiTitle": "MimoSupporter",
  "help.aiSubtitle": "Kysy mitä tahansa MimoBookista",
  ...
  "help.art8C2": "Pro (79 €/kk) — Kaikki tyypit, 10 henkilöä, mukautetut mallit, AI-chatbot-tuki.",
...
const sv: TranslationKeys = {
  ...
  "cta.subtitle": "Gå med besöksnäringsföretag som redan använder MimoBook för att effektivisera sina bokningar.",
  ...
  "privacy.s1P1": "Denna integritetspolicy förklarar hur MimoBook samlar in, använder och skyddar dina personuppgifter. Vi följer EU:s allmänna dataskyddsförordning (GDPR).",
  "privacy.s2Title": "2. Personuppgiftsansvarig",
  "privacy.s2P1": "MimoBook är personuppgiftsansvarig. Kontakta oss via supportsidan för dataskyddsfrågor.",
  ...
  "help.aiTitle": "MimoSupporter",
  "help.aiSubtitle": "Fråga vad som helst om MimoBook",
  ...
  "help.art8C2": "Pro (79 €/mån) — Alla typer, 10 personal, anpassade mallar, AI-chatbot-support.",
  ...
  "pricing.faqA4": "Varje företag får en varumärkt subdomän (t.ex. dittforetag.mimobook.com). Stöd för egna domäner finns på vår roadmap och kommer att erbjudas med enterprise-prissättning.",
  "pricing.faqQ5": "Vad är skillnaden mellan AI-chatbot-support och 24-timmarssupport?",
  "pricing.faqA5": "Alla planer inkluderar MimoAid, vår AI-chatbot som kan svara på frågor, hjälpa till med felsökning och guida dig genom funktioner. Chatboten är tillgänglig 24/7 i din instrumentpanel. Business-planen lägger till 24-timmarssupport: du kan eskalera varje konversation till vårt team på plattformen via chatboten och få ett garanterat svar inom 24 timmar.",
