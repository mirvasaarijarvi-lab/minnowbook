...
const fi: TranslationKeys = {
  ...
  "support.billingC2": "Pro (59 €/kk): Kaikki varaustyypit (yksi per tyyppi), jopa 10 työntekijäkäyttäjää, tekoälychatbot-tuki.",
  "support.billingC3": "Business (99 €/kk): Kaikki varaustyypit ja rajoittamaton määrä, rajoittamaton määrä työntekijäkäyttäjiä, prioriteettituki 24 tunnin vasteajalla.",
...
const sv: TranslationKeys = {
  ...
  "support.billingC2": "Pro (59 €/mån): Alla reserveringstyper (en per typ), upp till 10 anställda, AI-chatbotsupport.",
  "support.billingC3": "Business (99 €/mån): Alla reserveringstyper och obegränsat antal, obegränsat antal anställda, prioriterad support med 24 timmars svar.",
