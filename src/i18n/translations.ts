...
const fi: TranslationKeys = {
  ...
  "support.faqC7": "Tarjouksen tila ja vieraan hyväksyntä: jokaisella tarjouksella on tila Odottaa, Hyväksytty, Hylätty, Vanhentunut tai Luonnos, ja Tarjoukset-sivun painikkeilla voit suodattaa tilan mukaan. Anna Voimassa asti -päivä; avoimet tarjoukset vanhenevat sen jälkeen, ja Vanhenee pian näkyy kolme päivää ennen. Käytä Merkitse hylätyksi tai Avaa uudelleen vieraan päätöksen mukaan. Jokaisessa tarjoussähköpostissa on yksityinen linkki, josta vieras tarkistaa tarjouksen ja painaa Hyväksy tarjous. Saat ilmoituksen, tarjouksessa näkyy Vieras hyväksyi, ja vahvistat varauksen painamalla Vahvista. Vieraan varauksesta tehdyssä tarjouksessa näkyvät varauksen vieras ja yhteystiedot, ja varaus näyttää siitä tehdyt tarjoukset.",
  "support.faqC6":
