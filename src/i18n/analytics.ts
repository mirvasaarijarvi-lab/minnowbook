...
const en = {
  ...
  "rp.week": "This week",
  "rp.month": "This month",
  "rp.quarter": "This quarter",
  "rp.year": "This year",
  "rp.custom": "Custom dates",
  "rp.from": "From",
  "rp.to": "To",
  "rp.help": "Every section below uses this period.",
  "rp.printAll": "Print whole page",
  "rp.printSection": "Print this section",
  "rp.coverTitle": "Reports",
  "dd.mode.discount": "Discount code",
  "dd.mode.guestType": "New or returning guests",
  "dd.mode.weekday": "Weekday",
  "dd.mode.groupSize": "Group size",
  "dd.mode.utilisation": "Utilisation of capacity",
  "dd.mode.offer": "Offer or direct booking",
  "dd.mode.kitchen": "Kitchen items",
  "dd.fromOffer": "From an offer",
  "dd.direct": "Direct booking",
  "dd.copyLink": "Copy link",
  "dd.linkCopied": "Link copied. It opens this view and period.",
  "dd.new": "New guests",
  "dd.returning": "Returning guests",
  "dd.noCode": "No discount code",
...
const fi: Partial<Record<AnalyticsKey, string>> = {
  ...
  "rp.period": "Aikaväli",
  "rp.week": "Tämä viikko",
  "rp.month": "Tämä kuukausi",
  "rp.quarter": "Tämä vuosineljännes",
  "rp.year": "Tämä vuosi",
  "rp.custom": "Omat päivät",
  "rp.from": "Alkaen",
  "rp.to": "Päättyen",
  "rp.help": "Kaikki alla olevat osiot käyttävät tätä aikaväliä.",
  "rp.printAll": "Tulosta koko sivu",
  "rp.printSection": "Tulosta tämä osio",
  "rp.coverTitle": "Raportit",
  "dd.mode.discount": "Alennuskoodi",
  "dd.mode.guestType": "Uudet tai palaavat vieraat",
  "dd.mode.weekday": "Viikonpäivä",
  "dd.mode.groupSize": "Ryhmän koko",
  "dd.mode.utilisation": "Kapasiteetin käyttö",
  "dd.mode.offer": "Tarjous vai suora varaus",
  "dd.mode.kitchen": "Keittiön tuotteet",
  "dd.fromOffer": "Tarjouksesta",
  "dd.direct": "Suora varaus",
  "dd.copyLink": "Kopioi linkki",
  "dd.linkCopied": "Linkki kopioitu. Se avaa tämän näkymän ja aikavälin.",
  "dd.new": "Uudet vieraat",
  "dd.returning": "Palaavat vieraat",
  "dd.noCode": "Ei alennuskoodia",
...
const sv: Partial<Record<AnalyticsKey, string>> = {
  ...
  "rp.period": "Period",
  "rp.week": "Denna vecka",
  "rp.month": "Denna månad",
  "rp.quarter": "Detta kvartal",
  "rp.year": "Detta år",
  "rp.custom": "Egna datum",
  "rp.from": "Från",
  "rp.to": "Till",
  "rp.help": "Alla avsnitt nedan använder denna period.",
  "rp.printAll": "Skriv ut hela sidan",
  "rp.printSection": "Skriv ut detta avsnitt",
  "rp.coverTitle": "Rapporter",
  "dd.mode.discount": "Rabattkod",
  "dd.mode.guestType": "Nya eller återkommande gäster",
  "dd.mode.weekday": "Veckodag",
  "dd.mode.groupSize": "Gruppstorlek",
  "dd.mode.utilisation": "Kapacitetsutnyttjande",
  "dd.mode.offer": "Offert eller direktbokning",
  "dd.mode.kitchen": "Köksartiklar",
  "dd.fromOffer": "Från offert",
  "dd.direct": "Direktbokning",
  "dd.copyLink": "Kopiera länk",
  "dd.linkCopied": "Länken kopierad. Den öppnar denna vy och period.",
  "dd.new": "Nya gäster",
  "dd.returning": "Återkommande gäster",
  "dd.noCode": "Ingen rabattkod",
